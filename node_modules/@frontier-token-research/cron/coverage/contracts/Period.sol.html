...
<html lang="en">
<head>
    <title>Code coverage report for contracts/Period.sol</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">contracts/</a> Period.sol
    </h1>
    <div class='clearfix'>
...
&nbsp;
    ...
    */
    constructor(uint256 _T) public {
        <span class="missing-if-branch" title="else path not taken" >E</span>require(_T &gt; 0, 'EMPTY_PERIOD');
        T = _T;
    ...
    */
    function getPeriodNumber() public view returns (uint256) {
        <span class="missing-if-branch" title="else path not taken" >E</span>assert ((block.number - initOffset) &gt;= 0);
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Wed Jun 13 2018 09:14:43 GMT+0200 (CEST)
</div>
</div>
